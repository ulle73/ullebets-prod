...
def test_score_evaluation_reports_t30_without_using_it_for_official_clv() -> None:
    report = _evaluate_selection_clv(
        ...
        closing_lines=[
            {
                "offer_key": "offer-1",
                "closing_snapshot_time": datetime(2026, 7, 30, 13, 30, tzinfo=UTC),
    ...
    assert report["fallback_t30_rows"] == 1
