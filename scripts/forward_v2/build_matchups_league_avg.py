...
from ullebets_v2.matchups.service import run_matchups_league_avg_build


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build V2 league-average matchup rankings from fixtures and teamprofiles.")
