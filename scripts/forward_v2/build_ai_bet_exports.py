...
def main() -> int:
    ...
    if args.target_mode == "replay-fixtures":
        if not requested_dates:
            raise RuntimeError("--date or --start-date/--end-date is required in replay-fixtures target mode.")
        ...
        if not requested_dates:
            raise RuntimeError("--date or --start-date/--end-date is required in legacy-backtest target mode.")
