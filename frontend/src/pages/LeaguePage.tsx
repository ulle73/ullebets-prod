...
export function LeaguePage(){
 ...
 const{league,teams,matches,statRows}=query.data;const statKeys=useMemo(()=>Array.from(new Set(statRows.map((row)=>row.statKey))).sort((a,b)=>a.localeCompare(b,'sv')),[statRows]);const selectedStat=stat||statKeys[0]||'';
