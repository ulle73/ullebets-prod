...
def dispatch_get(
    ...
    if normalized_path.startswith("/api/v1/matches/"):
        match_key = unquote(normalized_path.removeprefix("/api/v1/matches/"))
    ...
    if normalized_path.startswith("/api/v1/teams/"):
        team_key = unquote(normalized_path.removeprefix("/api/v1/teams/"))
    ...
    if normalized_path.startswith("/api/v1/leagues/"):
        league_key = unquote(normalized_path.removeprefix("/api/v1/leagues/"))
