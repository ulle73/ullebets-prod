        ...
        return [
            build_parity_report_row(
                workflow_entry={
                    ...
                    "parity_proof": "treat no eligible targets as a clean no-op while preserving the same directed line-generation contract",
                },
    ...
    return [
        build_parity_report_row(
            workflow_entry={
                ...
                "v2_job": "build_model_snapshots.py",
                "v2_outputs": ["raw_odds_kambi", "unibet_event_links", "market_offers", "model_snapshots"],
                "smoke_test": "dry-run replay or live window through the V2-owned JS model runtime",
                "parity_proof": "V2 rebuilds the legacy EV/runtime inputs from V2 canonical profiles and raw match history, runs the copied JS formulas locally, and compares directed line coverage before persistence",
            },
            counts_old={
